...
app.layout = html.Div(children=[html.H1('SpaceX launch Records Dashboard',
                                ...
                                dcc.Dropdown(id="site-dropdown",options=options,value="VAFB SLC-4E",
                                ...
                                dcc.RangeSlider(id='payload-slider',
                                       ...
                                       marks={i*1000: str(i*1000) for i in range(10000)},
...
def get_pie_chart(entered_site):
    ...
    if entered_site=='ALL':
        ...
        data2=filtered_df['class'].value_counts()
        fig2=px.pie(
            data2,values=data2.values,names=data2.index,title=f"chart for {entered_site} site"
        )
        return fig2
